...
const DrawBoundingBoxes: React.FC<DrawBoundingBoxesProps> = ({
  uploadedFileName,
}) => {
  ...
  return (
    <div className="bbox-container">
      <Heading level={4}>
        Draw bounding boxes around the {uploadedFileName} image:
      </Heading>
      <div className="bbox-crop-container">
        {imageUrl && (
          <img className="bbox-image" src={imageUrl} alt="Uploaded Image" />
        )}
        <canvas
          ref={canvasRef}
