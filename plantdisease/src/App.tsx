            ...
            {!showPrediction ? (
              <div>
                ...
                {uploadSuccessful && !isLeaf && (
                  <div>
                    ...
                    <Heading level={6} color="green">
                      We are processing your image, please wait while we check
                      if it's a leaf ...
                    </Heading>
                  </div>
                )}
                {uploadSuccessful && loading && <Loader variation="linear" />}
                ...
                {uploadSuccessful && isLeaf && predictionInProgress && (
                  <div className="button-container">
                    <Heading level={6} color="green">
                      We are processing your image, please wait while we
                ...
                {error && (
                  <p className="error-message">
                    Error: The uploaded file is not a leaf.
                  </p>
                )}
              </div>
            ) : (
          ...
          <div className="example-pictures">
            <Card>
              <Flex direction="row" alignItems="flex-start">
                <Image alt="Good example" src="/good-image.jpg" width="33%" />
                <Flex
                  direction="column"
                ...
                >
                  ...
                  <Heading level={5}>Good Example</Heading>

                  <Text as="span">
                    Here is an example of a good picture! Picture should include
                    a couple of leaves but be close enough. It should also be on
                    the field.
                  </Text>
                </Flex>
              </Flex>
            ...
            <Card>
              <Flex direction="row" alignItems="flex-start">
                <Image
                  ...
                  width="32.5%"
                />
                <Image alt="Bad example" src="/bad-example-2.jpg" width="33%" />
                <Flex
                  direction="column"
                  alignItems="flex-start"
                  gap={tokens.space.xs}
                >
                  ...
                  <Heading level={5}>Bad Example</Heading>

                  <Text as="span">
                    Here is an example of a bad picture! Leaves shouldn't be
                    cropped out. However, leaves should be visible, that means
